...
Tarjan’s Algorithm (SCC) – detects Strongly Connected Components and compresses cycles.

Kahn’s Algorithm (Topological Sort) – orders tasks in acyclic graphs.

Shortest / Longest Path Algorithms for DAGs – finds optimal and critical paths.
